...
public class MyRemote : MonoBehaviour
{
   ...
   // public Text errorServo; 
   // public Text errorPosition;
    void Start()
    {
        pythonScriptPathRelative = "../Assets/AssetsV7/Resources/DTProjExternals/PythonControllers/Output_PythonController.py";
...
arm = xarm.Controller('USB') # Connects the xarm through the USB 
    ...
    public void PositionOutofBounds(int Servo, int Position){

        //errorServo.text = Servo.ToString(); 
