...
//ARM AS INPUT 
//This script allows the user to use the XARM1S as Input 

//Pressing A saves the position 
//Pressing B Saves the Task 
//Pressing X Repeats the Task 
//Pressing Left Trigger will Start/Stop Arm as Input Mode 
...
public class MyRemote_Input : MonoBehaviour
{
    public bool isModeOn; 
    public string pythonCode ; 
    public string pythonScriptPathRelative;
    public string pythonScriptPath;
    public string PoseDataPathRelative;
    public string PoseDataPath;  
    public string AutomationpythonScriptPathRelative; 
    public string AutomationpythonScriptPath; 
    ...
    void Start()
    {
        ...
        pythonScriptPathRelative = "..Assets/AssetsV7/Resources/DTProjExternals/PythonControllers/InputController.py"; 
        pythonScriptPath = Path.Combine(Application.dataPath, pythonScriptPathRelative); 

        PoseDataPathRelative = "..Assets/AssetsV7/Resources/DTProjExternals/TextFiles/InputController_PoseData.txt";
        PoseDataPath = Path.Combine(Application.dataPath, PoseDataPathRelative); 

        AutomationpythonScriptPathRelative = "..Assets/AssetsV7/Resources/DTProjExternals/PythonControllers/InputController_TaskAutomation.py";
        AutomationpythonScriptPath = Path.Combine(Application.dataPath, AutomationpythonScriptPathRelative); 
...
myLines = position1 + '\n' + position2 +'\n'+ position3 +'\n'+ position4 +'\n'+ position5 +'\n'+ position6 +'\n' + 'STOP' +'\n'
try:
    myDataFile = open('../DTProjExternals/TextFiles/InputController_PoseData.txt', 'a')
